...
- Streamlined Project command center v1 with a visible Now/Why/Do focus, collapsed supporting signals, and collapsed journey map so the UI guides one next action without hiding deeper harness evidence.
