...
- Password Auth v0 with optional `TABLEX_AUTH_ENABLED=true`, first-user bootstrap, HTTP-only session cookies, logout, and server-backed user preferences. Google auth is planned behind the same harness-owned auth boundary.
