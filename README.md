...
- Analysis Notebook v0 with marimo source artifacts, static in-product HTML preview, run manifest, notebook report, run-level model diagnostics notebooks, summary VisualizationSpecs, Notebook Center index, controlled execution planning contracts, and lineage from Data Understanding and ExperimentRun context.
