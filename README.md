...
- Benchmark Dataset Catalog v1 with Home Credit, fraud, retail forecasting, basket, UCI, and OpenML source cards plus harness-only Kaggle credential probes, managed credential-free public archive/direct-file downloads, local primary-table import, relational catalog artifacts, and inferred join-key context without exposing external credentials to agents.
