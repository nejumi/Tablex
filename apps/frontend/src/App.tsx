...
const assetTypeCategoryMap: Record<string, AssetCategoryKey> = {
  ...
  prediction_input_integrity: "model_prediction",
  prediction_context_pack: "model_prediction",
  prediction_result_context: "model_prediction",
  prediction_review: "model_prediction",
...
const assetSearchPriorityByType: Record<string, number> = {
  ...
  prediction_batch: 0,
  prediction_input_integrity: 0,
  prediction_context_pack: 0,
  prediction_result_context: 0,
  prediction_review: 0,
