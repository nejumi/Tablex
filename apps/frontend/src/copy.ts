export const englishMessages = {
  ...
  predictionDrawerBody:
    "Choose a dataset snapshot to run through this model pipeline. The prediction input should not include target values used for training or validation.",
  predictionInputDataset: "Prediction input dataset",
...
export const japaneseMessages: LocaleMessages = {
  ...
  predictionDrawerBody:
    "このモデルのpipelineで予測するDatasetSnapshotを選びます。予測入力には、学習や検証に使ったtarget値を含めないでください。",
  predictionInputDataset: "予測入力データセット",
