...
export const japaneseMessages: LocaleMessages = {
  ...
  projectAssetsTitle: "Project Assets",
  projectAssetsEmpty:
    "登録済みデータセット、レポート、評価artifact、モデル出力、再利用可能なProject evidenceがここに表示されます。",
  projectAssetSupportingRecords: "支援記録",
  projectAssetSupportingRecordsHint:
    "会話turn、Agent transcript、log、バックグラウンド処理記録はlineageのため保持しますが、主要asset表からは分けて表示します。",
  ...
  previewArtifact: "artifactをプレビュー",
  downloadArtifact: "artifactをdownload",
