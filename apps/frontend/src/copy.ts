export const englishMessages = {
  ...
  leaderboardEmpty: "Models appear here after their reproducible pipelines pass validation and are ready for prediction and local download.",
  ...
  surfaceLeaderboardEmpty: "validated prediction-ready models appear here",
...
export const japaneseMessages: LocaleMessages = {
  ...
  leaderboardEmpty: "再現可能pipelineの検証が完了し、UI予測とローカルdownloadが可能になったモデルだけがここに並びます。",
  ...
  surfaceLeaderboardEmpty: "検証済みで予測可能なモデルがここに表示されます",
