export const englishMessages = {
  ...
  cloneProjectTitle: "Duplicate project",
  cloneProjectName: "New project name",
  cloneProjectMode: "Starting point",
  cloneProjectDataOnly: "Data only",
  cloneProjectDataOnlyDetail: "Reuse uploaded datasets and start again from the data-ready state.",
  cloneProjectFull: "Everything",
  cloneProjectFullDetail: "Copy plans, evaluation, experiments, models, reports, assets, and lineage. Agent power starts off.",
  cloneProjectAction: "Duplicate",
  cloningProject: "Duplicating",
  projectCloneNameSuffix: "copy",
  ...
  buildPipelineBundle: "Build local pipeline bundle",
  pipelineBundleRequested: "Bundle build requested",
  pipelineBundleUnavailable: "Reproducible pipeline is not registered",
  predictionRuntimeUnavailable: "UI prediction runtime is still being completed",
  pipelineRuntimeNeverRun: "Pipeline not run yet",
  pipelineRuntimeMissing: "Prediction runtime is being completed",
  ...
  predictionRequiredTablesUseUploads: "Tablex validates and reuses matching project tables when available. You can start with partial inputs; Codex reviews coverage, missing tables, and the safe execution path.",
  predictionPreparingProjectTables: "Validating matching project tables...",
  predictionAutomaticInputsReady: "Tablex selected {count} matching project inputs",
  predictionAutomaticInputsEmpty: "No matching project input has been selected yet.",
  predictionChangeInputs: "Review or change inputs",
  predictionTechnicalDetails: "Pipeline input requirements",
  predictionAdvancedOptions: "Prediction options",
  ...
  predictionStarting: "Starting prediction...",
  predictionFailedTitle: "Prediction could not start or complete",
  predictionStatusRefreshFailed: "Prediction is still active, but its latest status could not be refreshed",
  ...
  predictionCodexReviewPending: "Codex is managing this prediction",
  predictionCodexInputReviewTitle: "Codex is reviewing the prediction inputs",
  predictionCodexInputReviewBody: "The request was delivered. The prediction pipeline has not started yet.",
  predictionCommandRejectedTitle: "The prediction command was rejected",
  predictionCommandRejectedBody: "The pipeline has not started. Tablex returned this tool error to Codex for correction.",
  predictionPipelineQueuedTitle: "Prediction execution accepted",
  predictionPipelineQueuedBody: "Codex approved the inputs. The canonical pipeline is waiting for a compute slot.",
  predictionPipelineRunning: "The canonical prediction pipeline is running",
  predictionPipelineRunningBody: "Tablex is executing the registered feature and model pipeline on the selected inputs.",
  predictionExecutionElapsed: "Pipeline runtime: {seconds}s",
  predictionCodexReviewingResult: "Codex is reviewing the actual prediction result",
  predictionCodexReviewingResultBody: "Pipeline execution finished. Codex is checking the actual outputs before releasing them.",
  predictionOpenResultEvidence: "Open result evidence",
  predictionStatusUpdated: "Last state change: {time}",
  predictionCodexReviewCaveats: "Codex approved this result with caveats",
  predictionCodexReviewRejected: "Codex rejected this prediction result",
  ...
  turnStateLoading: "Checking agent state",
  ...
  workerDisplayPrediction: "Prediction",
  ...
  leaderboardLoadingTitle: "Loading ranked models",
  leaderboardLoadingBody: "Fetching the latest model results and prediction readiness...",
  leaderboardLoadFailedTitle: "Ranked models could not be loaded",
  ...
  leaderboardEmpty: "Prediction-enabled model candidates will appear here as they complete.",
...
export const japaneseMessages: LocaleMessages = {
  ...
  cloneProjectTitle: "プロジェクトを複製",
  cloneProjectName: "新しいプロジェクト名",
  cloneProjectMode: "開始地点",
  cloneProjectDataOnly: "データのみ",
  cloneProjectDataOnlyDetail: "アップロード済みデータを引き継ぎ、データ読み込み完了状態からやり直します。",
  cloneProjectFull: "すべて複製",
  cloneProjectFullDetail: "計画、評価、実験、モデル、レポート、アセット、lineageを複製します。Agent powerはOFFで開始します。",
  cloneProjectAction: "複製",
  cloningProject: "複製中",
  projectCloneNameSuffix: "のコピー",
  ...
  buildPipelineBundle: "ローカル実行バンドルを作成",
  pipelineBundleRequested: "バンドル作成を依頼済み",
  pipelineBundleUnavailable: "再現パイプラインは未登録です",
  predictionRuntimeUnavailable: "UI予測runtimeを完成中です",
  pipelineRuntimeNeverRun: "pipeline未実行",
  pipelineRuntimeMissing: "予測runtimeを完成中",
  ...
  predictionRequiredTablesUseUploads: "一致するプロジェクト内テーブルはTablexが検証して再利用します。一部入力だけでも開始でき、カバレッジ、不足テーブル、安全な実行方法はCodexが判断します。",
  predictionPreparingProjectTables: "プロジェクト内テーブルを検証しています...",
  predictionAutomaticInputsReady: "一致するプロジェクト入力を{count}件、自動選択しました",
  predictionAutomaticInputsEmpty: "一致するプロジェクト入力はまだ選択されていません。",
  predictionChangeInputs: "入力を確認・変更",
  predictionTechnicalDetails: "pipelineの入力要件",
  predictionAdvancedOptions: "予測オプション",
  ...
  predictionRun: "予測を実行",
  predictionStarting: "予測を開始しています...",
  predictionFailedTitle: "予測を開始または完了できませんでした",
  predictionStatusRefreshFailed: "予測は継続中ですが、最新状態を更新できませんでした",
  predictionNoDatasets: "このpipelineで予測するには、予測用データセットをアップロードしてください。",
  predictionCompleted: "予測バッチを登録しました",
  predictionCodexReviewPending: "Codexがこの予測を管理しています",
  predictionCodexInputReviewTitle: "Codexが予測入力を確認しています",
  predictionCodexInputReviewBody: "要求はCodexに届いています。予測pipelineはまだ開始していません。",
  predictionCommandRejectedTitle: "予測コマンドが拒否されました",
  predictionCommandRejectedBody: "pipelineは開始していません。Tablexはこのtool errorをCodexへ返し、修正を求めています。",
  predictionPipelineQueuedTitle: "予測実行を受理しました",
  predictionPipelineQueuedBody: "Codexが入力を承認しました。canonical pipelineはcompute slotを待っています。",
  predictionPipelineRunning: "canonical prediction pipelineを実行中です",
  predictionPipelineRunningBody: "選択した入力に対して、登録済みの特徴量・モデルpipelineを実行しています。",
  predictionExecutionElapsed: "pipeline実行時間: {seconds}秒",
  predictionCodexReviewingResult: "Codexが実際の予測結果を確認しています",
  predictionCodexReviewingResultBody: "pipeline実行は完了しました。結果を返す前にCodexが実出力を確認しています。",
  predictionOpenResultEvidence: "結果の根拠を開く",
  predictionStatusUpdated: "最終状態更新: {time}",
  predictionCodexReviewCaveats: "Codexが注意事項付きで利用可能と判断しました",
  predictionCodexReviewRejected: "Codexがこの予測結果を棄却しました",
  ...
  leaderboardLoadingTitle: "モデルランキングを読み込んでいます",
  leaderboardLoadingBody: "最新のモデル結果と予測準備状態を取得しています...",
  leaderboardLoadFailedTitle: "モデルランキングを読み込めませんでした",
  ...
  leaderboardEmpty: "UI予測が可能になったモデル候補から順に表示されます。",
