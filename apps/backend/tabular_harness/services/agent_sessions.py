...
def build_default_goal_text(db: Session, project: Project) -> str:
    ...
    return "\n".join(
        [
            ...
            "- Keep moving in Full Auto. Ask questions when useful, but if no answer is available, record reversible assumptions and continue. Do not wait for formal approval before doing non-destructive analysis, evaluation design, modeling experiments, diagnostics, or reports. Use Give Up only as a last resort.",
            "",
            "Current datasets:",
